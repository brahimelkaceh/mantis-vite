...
import { AppBar, Button, Card, Dialog, Divider, IconButton, LinearProgress, Modal, Slide, Stack, Toolbar, Typography } from '@mui/material';
...
const MasseContainer = ({ id, title }) => {
  ...
  const fetchMasseOeufChartData = async (id) => {
    try {
      setLoading(true);
      const result = await api.getMasseOeufChartData(id);

...
import AmbianceBlock from '../forms/AmbianceBlock';
  ...
  return (
    ...
    >
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary className="ambiance" aria-controls="panel1d-content" id="panel1d-header">
          <Stack direction="row" spacing={1.5} alignItems="center">
            {/* <Egg /> */}
            {/* <HeartIcon style={{ color: 'hotpink' }} /> */}
            <Typography variant="h6">Ambiance </Typography>
          </Stack>
        </AccordionSummary>
        <AccordionDetails>
          <AmbianceBlock formik={formik} />
        </AccordionDetails>
      </Accordion>
    </Box>
  );
